...
try {
    ...
    if ($runDatabaseTests) {
        ...
        */
        ...
        echo "Database created: ".$data['db_id']."<BR>";
        ...
        */
        ...
        echo "Database found: ".$data['db_id']."<BR>";
        ...
        */
        ...
        echo "Database user created: ".$data['db_user_id']."<BR>";
        ...
        */
        ...
        echo "Database user found: ".$data['db_user_id']."<BR>";
        ...
        */
        ...
        $info = $request->process();
        echo "Database deleted: ".$data['db_id']."<BR>";*/
    }
